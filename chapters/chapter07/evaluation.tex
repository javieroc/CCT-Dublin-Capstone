...
& Cryptographic Failures & 6 & 3 & 2 & 11 \\
& Injection & 2 & 2 & 0 & 4 \\
& Insecure Design & 3 & 1 & 1 & 5 \\
& Security Misconfiguration & 3 & 6 & 0 & 9 \\
& Vuln. Outdated Comp. & 0 & 1 & 0 & 1* \\
& Ident. Auth. Failures & 0 & 28 & 0 & 28 \\
& Software Data Integrity & 2 & 2 & 0 & 4 \\
& Server-Side Request Forgery & 0 & 3 & 0 & 3 \\
\cline{2-6}
& \textbf{Subtotal} & \textbf{16} & \textbf{46} & \textbf{15} & \textbf{77} \\
\hline
\multirow{2}{*}{Semgrep} & Various Rules & 0 & 0 & 101 & 101 \\
\cline{2-6}
& \textbf{Subtotal} & \textbf{0} & \textbf{0} & \textbf{101} & \textbf{101} \\
\hline
\multicolumn{2}{|l|}{\textbf{Total}} & \textbf{16} & \textbf{46} & \textbf{116} & \textbf{178} \\
\hline
\end{tabular}% 
}
\caption*{
...
\hline
\multirow{2}{*}{Semgrep} & Various Rules & 0 & 0 & 50 & 50 \\
\cline{2-6}
& \textbf{Subtotal} & \textbf{0} & \textbf{0} & \textbf{50} & \textbf{50} \\
\hline
\multicolumn{2}{|l|}{\textbf{Total}} & \textbf{2} & \textbf{30} & \textbf{50} & \textbf{82} \\
\hline
\end{tabular}%
}
\end{table}
